        ...
        <div className="p-6">
          <div className="flex items-start gap-4">
            <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${
              ...
              <span 
                className={`material-icons ${variant === 'danger' ? 'text-danger-600' : 'text-warning-600'}`}
                aria-hidden="true"
              >
            ...
            <div className="flex-1">
              <h3 id="confirm-modal-title" className="text-lg font-semibold text-neutral-900 mb-2">{title}</h3>
              <p id="confirm-modal-description" className="text-sm text-neutral-600">{message}</p>
            </div>
          </div>
        </div>
